...
const WorkExperience = (props: Props) => {
  return (
    ...
    >
      ...
      <div className="w-full flex space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory justify-center scrollbar scrollbar-track-[#053642] scrollbar-thumb-[#A1C181]/80">
        {/* Experience Card*/}
        <ExperienceCard />
      </div>
    </motion.div>
